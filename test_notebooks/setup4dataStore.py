...
# MAGIC %md
# MAGIC # (Optional) Delete Tables

# COMMAND ----------

# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4env.env_item_types;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4env.env_suppliers;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4env.env_supplier_item_map;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4env.env_supplier_item_map_orders;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4env.env_supplier_item_map_arrivals;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4env.env_supplier_item_map_arrivals_hist;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4env.env_supplier_item_map_orders_hist;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4eventlog.event_log;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4hist.hist_item_types;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4hist.hist_suppliers;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4hist.hist_supplier_item_map;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4hist.hist_supplier_item_map_orders;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4hist.hist_supplier_item_map_arrivals;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4hist.hist_supplier_item_map_arrivals_hist;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4hist.hist_supplier_item_map_orders_hist;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4ops.ops_pending_orders;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4ops.ops_pending_arrivals;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4ops.ops_pending_arrivals_hist;
# MAGIC DROP TABLE IF EXISTS hackathon_of_the_century.tables4ops.ops_pending_orders_hist;
